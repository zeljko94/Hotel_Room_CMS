    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 text-center">
                ...
                <form class="form-signin" action="?url=login/index" method="POST">
                    ...
                    <button class="btn btn-sm btn-primary btn-block" type="submit" name="loginSubmitBtn">Log in</button>
                    <label for="errorMsg" class="form-control-static"><h3 class="<?php echo $data['errorStyle'];?>"><?=$data['errors'];?></h3></label>
                </form>
            </div>
