            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <?php
                        ...
                        {
                                echo "<li><a href='?url=moderatorPage'>MODERATOR PAGE</a></li>";
                        }
                    ?>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 text-center">
                <form method="POST" action="?url=register" accept-charset="UTF-8" role="form" class="form-signin">
                ...
                <fieldset>
                    ...
                    <input class="form-control middle" placeholder="Name" name="name" type="text" value="" value="<?php echo $data['name'];?>">
                    ...
                    <input class="btn btn-sm btn-primary btn-block" type="submit" name="registerSubmitBtn" value="Register">
                    <br>
