        ...
        <div class="row">
            <div class="col-sm-6 text-center">
                <h1>Enter new users data</h1>
                 <form method="POST" action="?url=adminPage/addUser" accept-charset="UTF-8" role="form" class="form-signin">
                ...
                <fieldset>
                    ...
                    <input class="btn btn-lg btn-primary btn-block" type="submit" name="addUserButton" value="Add User">
