...
<head>
    ...
    <title>Moderator Page | Show users</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <form action="?url=moderatorPage/showUsers/<?php echo $data['searchBy'];?>/<?php echo $data['searchKeyword'];?>" method="POST">
                ...
                <table class="table table-bordered">
                    ...
                    <?php foreach($data['users'] as $user){ echo ""; ?>
                    <tr>
                        <td>
                            <?php echo $user->getId();?>
                        </td>
                        ...
                        <td>
                            ...
                            {
                                if($user->getPrava() > (int)$_SESSION['prava'])
                                {
                                    echo "<a href='?url=moderatorPage/deleteUser/". $user->getId() ."'>Delete user</a>";
                                }
                            }
                            ?>
                        </td>
                            ...
                            if(isset($_SESSION['prava']))
                                {
                                    if($user->getPrava() > (int)$_SESSION['prava'])
                                    {
                                        echo "<a href='?url=moderatorPage/editUser/" . $user->getId() . "'>Edit user</a>";
                                    }
                                }
                            ?>
                        </td>
                ...
                <a href="?url=moderatorPage/addUser" class="btn btn-info" role="button">Add new user</a>
        <!-- /.row -->
    </div>
    <!-- /.container -->
