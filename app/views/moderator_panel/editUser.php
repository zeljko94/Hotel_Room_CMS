...
<head>
    ...
    <title>Moderator Page | Edit user</title>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 text-center">
                <h1>Edit user</h1>
                 <form method="POST" action="?url=moderatorPage/editUser/<?php echo $data['user']->getId();?>" accept-charset="UTF-8" role="form" class="form-signin">
